...
import { AgregarUsuario, ActualizarUsuario, InactivarUsuario, ObtenerUsuarios, ObtenerUsuarioPorId } from '../../servicios/ServicioUsuarios'
...
const Usuarios = () => {
    ...
    const onClickProcesarUsuario = async(data) => {
        ...
        if(proceso === 1)
            ...
            data.idPlanta = filaSeleccionada.idUsuario;
            data.estado = true;
